    ...
    <div class="form-card hidden" id="editFormCard">
      ...
      <form id="editRecordForm" autocomplete="off">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            <label for="second_time">Second Time</label>
            <input type="text" id="second_time" name="second_time" required>
          </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function populateForm(record) {
        serialHidden.value = record.id;
        serialDisplay.value = record.id;
        ...
        first_time.value = record.first_date;
        second_time.value = record.second_date ?? '';
