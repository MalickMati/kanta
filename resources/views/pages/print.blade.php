...
@section('title', config('app.name') . ' - Print Invoice')
...
@section('main-content')
  <x-header heading="Print Invoice" para="Generate and print weight transaction invoices" />

  <div class="form-container">
    <!-- Search Section -->
    <div class="form-card search-section">
      <h2 class="form-title">
        Find Complete Weight Record
      </h2>
    ...
    <!-- Invoice Preview (Initially Hidden) -->
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      printBtn.addEventListener('click', async e => {
        ...
        const res = await ajaxRequest('{{ route('print.post') }}', 'POST', formData);
